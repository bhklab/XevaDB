...
const file_folder = '/Initial_Csv_File/mutation/';
...
const csvStream = csv.createWriteStream({ headers: ['sequencing_uid', 'sequencing_id'] });
const writableStream = fs.createWriteStream('../Final_Csv_File/sequencings_final.csv');
