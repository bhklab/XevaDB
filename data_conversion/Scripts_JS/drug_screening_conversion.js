...
let files_map = ['models_final.csv', 'drugs_final.csv']
let streams_map = [];
let mapped_data = {};
...
let csvStream = csv.createWriteStream({headers: ["id", "model_id", "drug_id", "time", "volume", "volume_normal"]});
                      ...
                      .on('end', () => {
                        ...
                        results.forEach((data) => {
                            if(data[0] === "model.id" || data[0] === "") {}
                                ...
                                csvStream.write({id: id++, model_id: mapped_data[data[1]], drug_id: mapped_data[data[2]], time: data[3], volume: data[4], volume_normal: data[5]});
                            }
                        })
